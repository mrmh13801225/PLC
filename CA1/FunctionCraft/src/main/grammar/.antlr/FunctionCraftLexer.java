...
public class FunctionCraftLexer extends Lexer {
	...
	public static final int
		...
		RBRACE=58, COMMA=59, SEMICOLON=60, COLON=61, CASE=62, DOT=63, IDENTIFIER=64, 
		SINGLE_LINE_COMMENT=65, MULTY_LINE_COMMENT=66, WS=67;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "FUNCTION", "END_OF_SCOPE", "LAMDA", "MAIN", "RETURN", 
			...
			"APPEND", "LBRACE", "RBRACE", "COMMA", "SEMICOLON", "COLON", "CASE", 
			"DOT", "IDENTIFIER", "SINGLE_LINE_COMMENT", "MULTY_LINE_COMMENT", "WS"
		};
	}
