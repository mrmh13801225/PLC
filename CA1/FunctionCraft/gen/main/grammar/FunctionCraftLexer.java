...
public class FunctionCraftLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "FUNCTION", "END_OF_SCOPE", "LAMBDA", 
			"MAIN", "RETURN", "IF", "ELSEIF", "ELSE", "CHOP", "CHOMP", "PUSH", "PUTS", 
			"METHOD", "LENGTH", "PATTERN", "MATCH", "NEXT", "BREAK", "LOOP", "DO", 
			"FOR", "IN", "FLOAT_VAL", "INT_VAL", "TRUE", "FALSE", "STRING_VAL", "LPAR", 
			"RPAR", "LBRACKET", "RBRACKET", "PLUS", "MINUS", "MULT", "DIV", "MOD", 
			"PLUS_PLUS", "MINUS_MINUS", "GEQ", "LEQ", "GTR", "LES", "EQL", "NEQ", 
			"AND", "OR", "NOT", "ASSIGN", "PLUS_ASSIGN", "MINUS_ASSIGN", "MULT_ASSIGN", 
			"DIV_ASSIGN", "MOD_ASSIGN", "APPEND", "LBRACE", "RBRACE", "COMMA", "SEMICOLON", 
			"DOT", "COLON", "IDENTIFIER", "SINGLE_LINE_COMMENT", "MULTY_LINE_COMMENT", 
			"WS"
		};
	}
